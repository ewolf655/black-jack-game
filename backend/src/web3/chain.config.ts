export const chainConfig = {
	...
	ethereum: {
		...
		ethhelper: '0x0c9F9096f2747Ef9f5b3173A4Eb2f651D12D8d39',
	...
	goerli: {
		...
		chainId: 5,
		rpcUrls: [
			'https://eth-goerli.g.alchemy.com/v2/4qdi54Bjo9saX6OVnWYk_WiBQlrcP0-2'
		],
		wsUrls: [
			''
		],
		ethhelper: '0x85cCa1787eAbE81A9778c74Fe725F1b48d59bF32',
		blockExplorer: 'https://goerli.etherscan.io',
		blockExplorerApiKey: 'VJ6D3VV58G1CC97BGJJ62CHD21CES1P8SV',
		blockExplorerApiEndpoint: 'https://api.goerli.etherscan.io',
		router: '',
		factory: '',
		feeDistributor: '',
		simulator: '',
